...
coord_csv = "empire structure_cities_kml_export.csv"
points_csv = "Empire structure maps_points.csv"
lines_csv = "Empire structure maps_lines.csv"
...
write_geojson("points.geojson", points_geojson)
lines_geojson = load_features(lines_csv, "LineString",
                  capital_types, coord, version, version_date,
                  separator="\t", encoding="utf-16")    
write_geojson("lines.geojson", lines_geojson)
geojson2js("lines.geojson", "import_lines_geojson.js", "linestrings")
geojson2js("points.geojson", "import_points_geojson.js", "points")        
